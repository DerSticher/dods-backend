...
public class ParseDependencyServiceServiceTest extends AbstractParseServiceTest {

    @Autowired
    private ParseDependencyService service;
    ...
    public void testParse() {
        ...
        String voraussetzung = service.parseDependency(document);
    ...
    public void testNotFound() {
        ...
        assertNull(service.parseDependency(document));
    }
