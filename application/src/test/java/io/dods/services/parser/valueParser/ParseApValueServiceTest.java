...
public class ParseApValueServiceTest extends AbstractParseServiceTest {

    enum Type {POSITIVE, NEGATIVE}

    @Autowired
    private ParseApValueService service;
    ...
    public void testParsePositive() {
        ...
        for (String line : lines) {
            ...
            int i = service.parseApValue(document);
    ...
    public void testNotFound() {
        ...
        assertEquals(0, service.parseApValue(document));
    }
